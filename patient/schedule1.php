...
if ($userfetch) {
    $userid = $userfetch["pid"] ?? ''; // Using null coalescing operator to handle potential null
    $username = $userfetch["pname"] ?? ''; // Using null coalescing operator to handle potential null
} else {
    $userid = ''; // Default value or handle the error accordingly
    $username = ''; // Default value or handle the error accordingly
}
                     ...
                     <table border="0" class="profile-container">
                         <tr>
                             ...
                             <td style="padding:0px;margin:0px;">
                                 ...
                                 <p class="profile-subtitle"><?php echo substr($useremail ?? 'S',0,22)  ?></p>
                             </td>
                         </tr>
                         <tr>
                             <td colspan="2">
                                        ...
                                        <td style="width: 25%;">
                                                <div  class="dashboard-items search-items"  >
                                                    ...
                                                    <div style="width:100%">
                                                            ...
                                                            <br>
                                                            <a href="booking0complete.php?id='.$scheduleid.'" ><button  class="login-btn btn-primary-soft btn "  style="padding-top:11px;padding-bottom:11px;width:100%"><font class="tn-in-text">Book Now</font></button></a>
                                                    </div>
