...
// Prepare and execute the statement to fetch patient details
...
<div class="container">
    ...
    if ($_POST && !empty($_POST["search"])) {
        ...
        $stmt = $database->prepare($sqlmain);
        $stmt->bind_param("ssss", $today, $keyword_wildcard, $keyword_wildcard, $keyword_wildcard);
        $stmt->execute();
        $result = $stmt->get_result();
            ...
            <tr>
                ...
                <td>
                    <form action="" method="post" class="header-search">
                        <input type="search" name="search" class="input-text header-searchbar" placeholder="Search Doctor name or Email or Date (YYYY-MM-DD)" list="doctors" value="<?php echo isset($keyword) ? $keyword : '' ?>">&nbsp;&nbsp;
                        <datalist id="doctors">
                            <?php
